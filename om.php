  ...
  <div class="card-deck mb-1 text-center">
    <div class="card mb-4 shadow-sm">
      <div class="card-header">
        <h4 class="my-0 font-weight-normal">Operations Manager (OM) Dashboard</h4>
      </div>
      <div class="card-body">
        ...
        <button type="button" class="btn btn-lg btn-block btn-outline-primary"><a href="adduser.php"> Add a Member </a></button>
      </div>
    </div>
  </div>
</div>
